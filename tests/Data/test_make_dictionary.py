...
def test_make_dict_pos():
    ...
    subprocess.run(["python3", "./src/Data/scripts/make_dictionary.py", "--filepath", generated_output, "--option", "pos"])
...
def test_make_dict_no_pos():
    ...
    print("running file.. please wait.")
    subprocess.run(["python3", "./src/Data/scripts/make_dictionary.py", "--filepath", generated_output, "--option", "no_pos"])
    assert filecmp.cmp(expected_output, generated_output)